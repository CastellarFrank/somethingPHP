<?php
     //INCLUYENDO CODIGO
      include('code/myAuthenticationClass.php');
      include ('code/mainly.php');
      include('code/execute.php');
      mainlyProject::callVerifyLogin();
?>
        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>ALL TABLES <small>Tables Managment</small></h1>
                </div>
                    ...
                    <div class="span12">
                        <div id="testingScroll">
                            <?php 
                                ...
                                $temp->showTables();
                                $temp->disconnect();
                                echo "<script>$('#testingScroll').mCustomScrollbar({horizontalScroll:true});</script>";
                                ?>
                        </div>
                    </div>
                </div>

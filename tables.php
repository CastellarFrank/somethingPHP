            ...
            <ul class="navigation">   
                ...
                <li>
					...
					<ul>
                        ...
                        <li><a href="ui.html">UI Elementssss</a></li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="editor.html">Editores</a></li>  
                        <li><a href="wizard.html">Wizard</a></li>
                    </ul>
                </li>
                <li><a href="statistic.html" class="blred">Statistic</a></li>                
                <li class="active">
                    <a href="#" class="bldblue">tablas</a>
                    <div class="open"></div>
                    <ul>
                        <li class="active"><a href="tables.html">Simples</a></li>
                        <li><a href="tables_dynamic.html">Dinamicas</a></li>                    
                    </ul>
                </li>
                <li>
        ...
        <div class="body">
			...
			<li>                
                ...
                <li>
                    <a href="#" class="button dblue">
                        ...
                        <div class="name">tablas</div>
                    </a> 
                    <ul class="sub">
                        <li><a href="tables.html">Simples</a></li>
                        <li><a href="tables_dynamic.html">Dinamicas</a></li>
                    </ul>                                        
                </li>
                <li>
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>Panel administrativo<small>promo2GO panel</small></h1>
                </div>
                        ...
                        <div class="block">
                            ...
                            <div class="data-fluid">
                                <table cellpadding="0" cellspacing="0" width="100%" class="table table-hover">
									...
									<tbody>
										<?php
									$strsql="SELECT nombre,email,fechain,sexo,sueldo,id FROM usuarios";
									$items=mysqli_query($conexion,$strsql);
								...
								while($row=mysqli_fetch_array($items))
									...
									//$tbl->addCell("<a href=\"?modulo=mantenimientousuario&idusuario=$id\">Perfil</a>");
									}
									?>	
